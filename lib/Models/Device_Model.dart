...
class Device {
  ...
  DateTime? get lastPositionDate {
    ...
    return DateTime.fromMillisecondsSinceEpoch(position?.timestamp ?? 0);
  }
  ...
  DeviceNetworkStatus? _networkStatus() {
    ...
    final dateAlive = now.subtract(keepAlive ?? Duration());
    final dateSleeping = now.subtract(sleepingTimeout ?? Duration());
